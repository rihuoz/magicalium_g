...
public class ClientSetup {
    ...
    private static void setRenderLayerTranslucent() {
        ItemBlockRenderTypes.setRenderLayer(InitFluids.STEAM_BLOCK.get(), RenderType.translucent());
        ItemBlockRenderTypes.setRenderLayer(InitFluids.STEAM_FLUID.get(), RenderType.translucent());
        ItemBlockRenderTypes.setRenderLayer(InitFluids.STEAM_FLOWING.get(), RenderType.translucent());

        ItemBlockRenderTypes.setRenderLayer(InitBlocks.TEST_OL_BLOCK.get(), RenderType.translucent());
